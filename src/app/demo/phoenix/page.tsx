...
export const metadata: Metadata = {
  ...
  description: "Illustrative Phoenix metro waitlist samples for staging and demos.",
  ...
  return (
    <MarketingLayout>
      <div className="mx-auto max-w-[900px] px-4 py-10 sm:px-6">
        <p className="text-xs font-semibold uppercase tracking-wider text-ah-warm">Internal demo</p>
        ...
        <p className="mt-12 rounded-lg border border-ah-border bg-ah-bg-alt p-4 text-sm text-ah-muted">
          <strong className="text-ah-ink">Developers:</strong> Data comes from{" "}
          <code className="text-xs">src/data/phoenix-demo-samples.ts</code>. Run{" "}
          <code className="text-xs">npm run db:seed</code> to insert the same rows into Postgres for local API or Prisma
          Studio.
        </p>
      </div>
    </MarketingLayout>
