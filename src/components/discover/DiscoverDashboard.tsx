...
import { PodDiscoveryCard } from "./PodDiscoveryCard";
      ...
      <header className="space-y-6">
        <div className="rounded-3xl bg-gradient-to-br from-[var(--surface-elevated)] to-ah-bg-alt/40 px-5 py-6 shadow-[var(--shadow-card)] ring-1 ring-black/[0.06] sm:px-7 sm:py-7">
          ...
          <p className="mt-2 max-w-lg text-sm leading-snug text-ah-muted">
            Real-world plans while you wait for your pod—partner tables and small meetups. Pick a vibe, join what fits, or
            host something low-pressure.
          </p>
        ...
        {podSummary ? <PodRhythmCard {...podSummary} /> : <PodDiscoveryCard />}
