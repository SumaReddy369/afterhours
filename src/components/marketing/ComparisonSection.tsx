...
const rows = [
  ...
  {
    left: "Feeds and swipes fill the gap for an hour.",
    right: "AfterHours gives you people who show up again—week after week—in the same slot.",
  },
];
  ...
  return (
    <section id="why-afterhours" className="scroll-mt-24 px-4 py-16 sm:px-6 sm:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        >
          Same people. Same evening. Six weeks—designed for young professionals in a new city who want connection without
          turning social life into a second job.
        </motion.p>
