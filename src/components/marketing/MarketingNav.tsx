...
const links = [
  { href: "/#why-product", label: "Overview" },
  { href: "/#pod-demo", label: "Live demo" },
  { href: "/#how-it-works", label: "How it works" },
  { href: "/#season-progression", label: "6 weeks" },
  { href: "/#trust-safety", label: "Trust & safety" },
  { href: "/#why-afterhours", label: "Compare" },
...
export function MarketingNav() {
  ...
  return (
    <header className="marketing-nav-blur sticky top-0 z-[100] border-b border-ah-border/50 backdrop-blur-xl backdrop-saturate-150">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:h-16 sm:px-6">
        ...
        <nav className="hidden flex-wrap items-center justify-end gap-1 md:flex" aria-label="Primary">
          {links.map((l) => (
            <Link
              key={l.href}
              href={l.href}
